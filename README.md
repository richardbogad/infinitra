...
- [A Journey into the Unknown](#a-journey-into-the-unknown)
- [Core Features](#core-features)
- [The Unwritten Roadmap](#the-unwritten-roadmap)
...
**INFINITRA is in Early Access.** We are embarking on a monumental experiment: to build a persistent, procedurally generated universe on a scale that has never existed before, visitable by millions of users.

This is uncharted territory. A project this ambitious means the future is unwritten. We don't know exactly where this journey will lead or how gameplay will evolve in such a massive, shared space—and that is the most exciting part.

**This is where you come in.** As an early pioneer, you are more than a player; you are a co-explorer helping to shape the future of this cosmos. We are building this with you and for you. We are incredibly curious to hear your ideas, feature requests, and wildest suggestions. What do you want to do in a universe this big?

Help us figure it out. Join the [**Discussions**](https://github.com/richardbogad/INFINITRA/discussions) and be part of the conversation.

To fund the server infrastructure and our continued development, we invite you to **support the project with a subscription.** Subscribers gain access to extended features - see below for more information.
...
-   **Worlds Born from Math:** Experience a universe where every location is unique. The procedural generation engine ensures that your discoveries are your own.
-   **Shared Exploration:** You are not alone. Connect with other explorers in real-time to share in the discovery of new and wondrous sights. (Note: Seeing other players requires a subscription).
-   **Shape Your Reality:** Find, collect, and use powerful items. Heal yourself with a health kit, soar through the skies with a Jetpack, save your favorite discoveries with a Location Saver, or even alter the world with Carver Items.
...
Our roadmap is a living document, guided by the possibilities of the engine and the desires of our community. While the ultimate destination is unknown, here are some of the landmarks we aim to build along the way. Your feedback will help us prioritize these and discover new ones.

-   **Player-Driven Worlds:** Gain tools to permanently modify the environment, creating your own structures and outposts.
-   **A Living Economy:** An item trading system to allow a player-driven marketplace to emerge.
...
-   **Latest Early Access Release:** [**Download INFINITRA**](https://github.com/richardbogad/INFINITRA/releases)
...
You can create an account and manage your subscription directly **within the INFINITRA software.**

-   **Guest:** Launch the game and explore the universe solo in offline mode. No account needed.
-   **Registered User (Free):** Create a free account **inside the game** to have your last visited location saved.
-   **Subscriber:** **Support the grand experiment!** A subscription helps us pay for servers and build the future of INFINITRA. As a thank you, subscribers unlock key features like the ability to see other players exploring the world, using items and your inventory, and storable locations.
...
This is an Early Access build, and performance optimizations are ongoing. For the best experience, we recommend:
